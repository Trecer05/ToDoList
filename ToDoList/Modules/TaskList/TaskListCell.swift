...
final class TaskListCell: UITableViewCell {
    ...
    func configure(with viewModel: TaskListRowViewModel) {
        ...
        completionButton.accessibilityLabel = viewModel.isCompleted
            ? "Отметить задачу невыполненной"
            : "Отметить задачу выполненной"

        completionButton.accessibilityValue = viewModel.isCompleted
            ? "Выполнено"
            : "Не выполнено"
    }
